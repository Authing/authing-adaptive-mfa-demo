...
export declare class AuthenticationClient {
    ...
    resetPasswordByFirstLoginToken(params: {
        token: string;
        password: string;
    }): Promise<import("../..").Maybe<{
        message?: import("../..").Maybe<string> | undefined;
        code?: import("../..").Maybe<number> | undefined;
    }> | undefined>;
     ...
     *
     */
    setUdfValue(data: KeyValuePair): Promise<import("../..").Maybe<{
        key: string;
        dataType: import("../..").UdfDataType;
        value: string;
        label?: import("../..").Maybe<string> | undefined;
    }[]> | undefined>;
    /**
    ...
    isUserExists(options: {
        ...
        phone?: string;
        externalId?: string;
    }): Promise<import("../..").Maybe<boolean> | undefined>;
    /**
