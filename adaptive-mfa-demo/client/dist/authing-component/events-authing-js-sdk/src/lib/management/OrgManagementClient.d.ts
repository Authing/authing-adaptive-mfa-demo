...
export declare class OrgManagementClient {
    ...
    create(name: string, description?: string, code?: string, tenantId?: string): Promise<{
        ...
        rootNode: {
            id: string;
            orgId?: import("../../types/graphql.v2").Maybe<string> | undefined;
            name: string;
            nameI18n?: import("../../types/graphql.v2").Maybe<string> | undefined;
            description?: import("../../types/graphql.v2").Maybe<string> | undefined;
            descriptionI18n?: import("../../types/graphql.v2").Maybe<string> | undefined;
            order?: import("../../types/graphql.v2").Maybe<number> | undefined;
            code?: import("../../types/graphql.v2").Maybe<string> | undefined;
            root?: import("../../types/graphql.v2").Maybe<boolean> | undefined;
            depth?: import("../../types/graphql.v2").Maybe<number> | undefined;
            path: string[];
            createdAt?: import("../../types/graphql.v2").Maybe<string> | undefined;
            updatedAt?: import("../../types/graphql.v2").Maybe<string> | undefined;
            children?: import("../../types/graphql.v2").Maybe<string[]> | undefined;
        };
        nodes: {
            id: string;
            orgId?: import("../../types/graphql.v2").Maybe<string> | undefined;
     ...
     * @example
     *
     * const node = await managementClient.org.getNodeByCode('ORG_ID','CODE');
     *
     *
     * @returns {Promise<Node>}
     * @memberof OrgManagementClient
     */
    getNodeByCode(orgId: string, code: string): Promise<import("../../types/graphql.v2").Maybe<{
        id: string;
        orgId?: import("../../types/graphql.v2").Maybe<string> | undefined;
        name: string;
        nameI18n?: import("../../types/graphql.v2").Maybe<string> | undefined;
     ...
     * @memberof OrgManagementClient
     */
    getNodeById(nodeId: string): Promise<import("../../types/graphql.v2").Maybe<{
        id: string;
        orgId?: import("../../types/graphql.v2").Maybe<string> | undefined;
        name: string;
        nameI18n?: import("../../types/graphql.v2").Maybe<string> | undefined;
    ...
    deleteNode(orgId: string, nodeId: string): Promise<{
        message?: import("../../types/graphql.v2").Maybe<string> | undefined;
        code?: import("../../types/graphql.v2").Maybe<number> | undefined;
    }>;
    /**
     * @name moveNode 移动节点
     * @name_zh 移动节点
    ...
    rootNode(orgId: string): Promise<{
        ...
        depth?: import("../../types/graphql.v2").Maybe<number> | undefined;
        path: string[];
        codePath: import("../../types/graphql.v2").Maybe<string>[];
        namePath: string[];
        createdAt?: import("../../types/graphql.v2").Maybe<string> | undefined;
        updatedAt?: import("../../types/graphql.v2").Maybe<string> | undefined;
        children?: import("../../types/graphql.v2").Maybe<string[]> | undefined;
