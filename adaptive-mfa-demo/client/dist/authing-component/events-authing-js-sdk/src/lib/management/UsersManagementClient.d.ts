...
export declare class UsersManagementClient {
     ...
     * @memberof UsersManagementClient
     */
    listDepartment(userId: string): Promise<any>;
    /**
     ...
     * @param data
     */
    setUdfValue(userId: string, data: KeyValuePair): Promise<import("../../types/graphql.v2").Maybe<{
        key: string;
        dataType: import("../../types/graphql.v2").UdfDataType;
        value: string;
        label?: import("../../types/graphql.v2").Maybe<string> | undefined;
    }[]> | undefined>;
    /**
    ...
    resignUser(userId: string): Promise<any>;
    resignUserBatch(userIds: string[]): Promise<any>;
}
